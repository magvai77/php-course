...
INSERT INTO zergs(unit,description,price)
...
Larvae will enter a pupal state and begin the metamorphosis into whichever strains the Hive requires.','0');
...
Drones are single-minded about their tasks, diligently working even in the face of raging combat and the possible destruction of the Hive.','50');
...
ith the correct growth stimuli, Overlords are even capable of evolving the ability to transport Zerg warriors within their hollow carapaces.','100');
...
Because the genetic code of the Zergling is so simple to replicate, a single Larva can spawn two separate Zerglings.','50');
...
This evolution implies that a widespread change is taking place within the Zerg hierarchy, a redistribution of power that will make the Zerg even more difficult to combat.','150');
...
and preferably with Siege Tank support.','100');
...
An apparently safe area can turn into a death trap as these monstrosities emerge and charge into the midst of their foes, giving little time to react.','75');
...
infiltrator organisms that can convincingly mimic enemy Zerg, Terrans, or Protoss.','150');
...
In a one-on-one battle, not much can stand against this regenerating monstrosity.','75');
...
Seeing the immense potential of this parasite, the Queen of Blades is busy incubating new strains that can live longer outside of their host.','100');
...
which can rapidly strike at several opponents as it explosively disintegrates. In large numbers or against weak defenses, Mutalisks are a deadly threat.','100');
...
The Corruptor is a genetic marvel that can cover targets in acid, causing them to take additional damage from attacks.','150');
...
Nydus Worms pose a grave threat to areas previously thought to be secure.','100');
...
and only the final viable code is used by Zerg Larvae to morph into new Ultralisks.','300');
...
Brood Lords are not very durable, and they make easy targets for most aerial-strike combatants.','150');
...
This lack of mobility can leave the Swarm Host vulnerable to quicker enemies with area damage like the Hellion.','200');
...
allowing it to quickly return to the fray and cause further mayhem.','100');
...
the Ravager is an intelligent evolutionary adaptation to the challenges the Zerg face on the battlefield.','100');
